	...
	if black =="":
		...
		clear()
	        ...
	        os.system("cd $HOME && git clone https://github.com/lovehacker404/402")
                print (logo)
	        love("\033[1;93mTool User Name :\033[1;95m     Habib ")
	        ...
	        love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name SpiderMan Password Habib")
                time.sleep(5)
		...
		os.system("cd $HOME && git clone https://github.com/lovehacker404/KaliIndia")
                print (logo)
		love("\033[1;96mCongratulations Habib Khan Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
